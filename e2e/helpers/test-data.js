 ...
 * Test Data Constants
 *
 * Known seed data values from data/*.json files.
...
/**
 * Test data for creating new records during E2E tests.
 * Uses unique names to avoid collisions with seed data.
 */
export const NEW_RECORDS = {
  DIVISION: {
