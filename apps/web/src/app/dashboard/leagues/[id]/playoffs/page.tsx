...
export default async function LeaguePlayoffsRedirectPage({
  params,
  searchParams,
}: {
  ...
  if (seasonParam) {
    ...
    redirect(`/dashboard/seasons/${season.id}/playoffs`);
  }
  ...
  redirect(`/dashboard/seasons/${activeSeason.id}/playoffs`);
}
